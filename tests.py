...
from logics import get_numbers_from_index,get_empty_list, get_index_from_number, \
...
class Test_2048(unittest.TestCase):
    ...
    def test_1(self):
        self.assertEqual(get_numbers_from_index(1, 2), 7)

    def test_2(self):
        self.assertEqual(get_numbers_from_index(3, 3), 16)
